...
#line 8 "interpreter.y" /* yacc.c:339  */
...
#line 137 "interpreter.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 88 "interpreter.y" /* yacc.c:355  */

  double number;  
  char * identifier;   /* NEW in example 7 */

#line 201 "interpreter.tab.c" /* yacc.c:355  */
};
...
#line 216 "interpreter.tab.c" /* yacc.c:358  */
...
{
       0,   144,   144,   148,   150,   152,   156,   158,   160,   162,
     166,   198,   234,   244,   280,   283,   286,   289,   292,   301,
     305,   308,   313,   322,   326
};
#endif
...
{
  "$end", "error", "$undefined", "VARIABLE", "UNDEFINED", "SEMICOLON",
  "PRINT", "READ", "ASSIGNMENT", "NUMBER", "PLUS", "MINUS",
  "MULTIPLICATION", "DIVISION", "MODULO", "LPAREN", "RPAREN", "UNARY",
  "POWER", "$accept", "program", "stmtlist", "stmt", "asgn", "print",
  "read", "exp", YY_NULLPTR
};
#endif
...
{
     -14,     2,    45,   -14,   -14,     3,   -14,    -2,    -9,   -14,
       5,     7,     9,    20,   -14,   -14,    -2,    -2,    -2,    14,
      12,   -14,   -14,   -14,     3,   -14,    14,    15,    15,    26,
      -2,    -2,    -2,    -2,    -2,    -2,     0,   -14,    41,    41,
      15,    15,    15,    15,   -14
};
...
{
       3,     0,     0,     1,     5,     0,     6,     0,     0,     4,
       0,     0,     0,     0,    24,    14,     0,     0,     0,    12,
       0,     7,     8,     9,    24,    11,    10,    20,    21,     0,
...
{
      26,    14,     3,    27,    28,    29,    20,    15,    16,    17,
      21,    13,    22,    18,    23,    36,    44,    38,    39,    40,
      41,    42,    43,    24,    30,    31,    32,    33,    34,    15,
      16,    17,    35,    35,    25,    18,    30,    31,    32,    33,
      34,     0,    37,     0,    35,    -2,     4,     0,     5,     0,
       6,     7,     8,    32,    33,    34,     0,     0,     0,    35
};

static const yytype_int8 yycheck[] =
{
      13,     3,     0,    16,    17,    18,    15,     9,    10,    11,
       5,     8,     5,    15,     5,     3,    16,    30,    31,    32,
      33,    34,    35,     3,    10,    11,    12,    13,    14,     9,
      10,    11,    18,    18,    13,    15,    10,    11,    12,    13,
      14,    -1,    16,    -1,    18,     0,     1,    -1,     3,    -1,
       5,     6,     7,    12,    13,    14,    -1,    -1,    -1,    18
};
...
{
       0,    20,    21,     0,     1,     3,     5,     6,     7,    22,
      23,    24,    25,     8,     3,     9,    10,    11,    15,    26,
      15,     5,     5,     5,     3,    23,    26,    26,    26,    26,
      10,    11,    12,    13,    14,    18,     3,    16,    26,    26,
      26,    26,    26,    26,    16
};
...
#line 167 "interpreter.y" /* yacc.c:1646  */
    {   
			...
			lp::Variable *var = (lp::Variable *) table.getSymbol((yyvsp[-2].identifier));

			// Check if the type of the variable is NUMBER
			if (var->getType() == NUMBER)
			{
				/* Get the identifier in the table of symbols as NumericVariable */
				lp::NumericVariable *n = (lp::NumericVariable *) table.getSymbol((yyvsp[-2].identifier));
			...
			else
			{
				...
				table.eraseSymbol((yyvsp[-2].identifier));

				// Insert $1 in the table of symbols as NumericVariable 
				// with the type NUMBER and the value $3
				lp::NumericVariable *n = new lp::NumericVariable((yyvsp[-2].identifier),VARIABLE,NUMBER,(yyvsp[0].number));
...
#line 199 "interpreter.y" /* yacc.c:1646  */
    {   
			...
			lp::NumericVariable *n2 = (lp::NumericVariable *) table.getSymbol((yyvsp[0].identifier));
			...
			{
				/* Get the identifier in the table of symbols as NumericVariable */
				lp::NumericVariable *n1 = (lp::NumericVariable *) table.getSymbol((yyvsp[-2].identifier));
			...
			else
			{
				...
				lp::NumericVariable *n1 = new lp::NumericVariable((yyvsp[-2].identifier),VARIABLE,NUMBER,n2->getValue());
...
#line 1397 "interpreter.tab.c" /* yacc.c:1646  */
    break;
...
#line 245 "interpreter.y" /* yacc.c:1646  */
    {   
			...
			/* Get the identifier in the table of symbols as Variable */
			lp::Variable *var = (lp::Variable *) table.getSymbol((yyvsp[-1].identifier));

			// Check if the type of the variable is NUMBER
			if (var->getType() == NUMBER)
			{
				/* Get the identifier in the table of symbols as NumericVariable */
				lp::NumericVariable *n = (lp::NumericVariable *) table.getSymbol((yyvsp[-1].identifier));
			...
			{
				// Delete $1 from the table of symbols as Variable
				table.eraseSymbol((yyvsp[-1].identifier));

				// Insert $1 in the table of symbols as NumericVariable 
				// with the type NUMBER and the read value 
				lp::NumericVariable *n = new lp::NumericVariable((yyvsp[-1].identifier),VARIABLE,NUMBER,value);
...
#line 327 "interpreter.y" /* yacc.c:1646  */
    {
			/* Get the identifier in the table of symbols as NumericVariable */
			lp::NumericVariable *n = (lp::NumericVariable *) table.getSymbol((yyvsp[0].identifier));
...
#line 341 "interpreter.y" /* yacc.c:1906  */
