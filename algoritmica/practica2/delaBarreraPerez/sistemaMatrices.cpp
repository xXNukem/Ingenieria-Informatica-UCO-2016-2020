...
double SistemaMatrices::sumatorio(std::vector<double> n, std::vector<float> t_practico, int a, int b)
{
	double resultado=0;
...
void SistemaMatrices::setSistema(std::vector<double> n,std::vector<float> t_practico, int nFil, int nCol)
{
