...
class SistemaMatrices
{
	...
	public:
		 ...
		 */
		void setSistema(std::vector<double> n,std::vector<float> t_practico, int nFil, int nCol);
		 ...
		 */
		double sumatorio(std::vector<double> n, std::vector<float> t_practico, int a, int b);
